...
function refresh_list()
{
  ...
  $text="<p>TO SUBMIT ONE OF THESE STORIES, TYPE \"~submit-story %url%\" IN SOYLENTNEWS IRC. COPY/PASTE URL INTO IRC FROM THIS LIST.</p>".PHP_EOL;
  $text=$text."{| class=\"wikitable\"".PHP_EOL;
  $text=$text."|-".PHP_EOL;
  $text=$text."! title !! link".PHP_EOL;
  for ($i=0;$i<count($file_list);$i++)
  {
    ...
    $text=$text."|-".PHP_EOL;
    $text=$text."| $title || [$url link]".PHP_EOL;
  }
  $text=$text."|}".PHP_EOL;
